      ...
      <div class="container">
            ...
            <table class="table table-borderless table-cart">
              ...
              <tbody>
                ...
                @foreach ($carts as $cart)
                  <tr>
                    <td style="width: 20%;">
                      <img class="cart-image w-100" src="{{ Storage::url($cart->product->galleries->first()->photo) }}"
                        alt="">
                    </td>
                    <td style="width: 35%;">
        ...
        <form action="{{ route('checkout') }}" id="locations" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" id="address_one" name="address_one" class="form-control" value="Setra Duta Cemara">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="address_two">Address 2</label>
                <input type="text" id="address_two" name="address_two" class="form-control" value="Blok B2 No. 34">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" id="zip_code" name="zip_code" class="form-control" value="32575">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-4 col-md-2 mt-auto mt-md-0">
              <div class="product-title text-success">${{ number_format($totalPrice ?? 0) }}</div>
              <div class="product-subtitle">Total</div>
            </div>
            <div class="col-8 col-md-3">
              <button class="btn btn-success mt-4 mx-4 w-100">Checkout Now</button>
            </div>
          </div>
        </form>
      </div>
