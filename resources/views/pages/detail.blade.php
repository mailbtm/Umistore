...
@section('content')
  <div class="page-content page-details">
    ...
    <section id="gallery" class="store-gallery mb-3">
      <div class="container">
        <div class="row">
            ...
            <div class="row">
              <div class="col-3 col-lg-12 mt-2 mt-lg-0" v-for="(photo, index) in photos" :key="photo.id"
                ...
                <a href="#" @click="changeActive(index)">
                  <img :src="photo.url" :class="{ active: index == activePhoto }" alt=""
            ...
            <div class="col-lg-2" data-aos="zoom-in">
              @auth
                <form action="{{ route('detail-add', $product->id) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <button class="btn btn-success text-white btn-block mb-3">Add p to Cart</button>
                </form>
              @else
              ...
              <ul class="list-unstyled">
                <li class="media">
                  ...
                  <div class="media-body">
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Non quasi odio, iure quidem quia velit?
                    Laudantium enim iusto, velit aliquam corporis quod sint quas fugit at! Explicabo, maiores? Deserunt,
                    autem!
                  </div>
                </li>
                <li class="media">
                  ...
                  <div class="media-body">
                    <h5 class="mt-2 mb-1">Akko Risky</h5>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Non quasi odio, iure quidem quia velit?
                    Laudantium enim iusto, velit aliquam corporis quod sint quas fugit at! Explicabo, maiores? Deserunt,
                    autem!
                  </div>
                ...
                <li class="media">
                  ...
                  <div class="media-body">
                    <h5 class="mt-2 mb-1">Hakka Risky</h5>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Non quasi odio, iure quidem quia velit?
                    Laudantium enim iusto, velit aliquam corporis quod sint quas fugit at! Explicabo, maiores? Deserunt,
                    autem!
                  </div>
